...
def _create_matters():
    ...
    matters = [
        ...
        {"matter_title": "Priya Sharma vs Metro Builders - Deficiency",
         "vertical": v_civil, "matter_type": _mt("Consumer Complaint", v_civil),
        ...
        {"matter_title": "Bharat Finance vs Sunita Devi - Cheque Bounce",
         "vertical": v_ni, "matter_type": _mt("Standard 138 Complaint", v_ni),
        ...
        {"matter_title": "Priya Sharma - Divorce Petition",
         "vertical": v_family, "matter_type": _mt("Divorce (Mutual Consent)", v_family),
